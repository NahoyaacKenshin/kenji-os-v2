        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 p-8 lg:p-12 relative z-10">
          ...
          <div className="flex flex-col justify-center space-y-6 order-2 lg:order-1">
            <div className="space-y-4">
              <div className="inline-block">
                <span className="text-sm font-mono text-cyan-400/70 tracking-wider uppercase">Welcome</span>
              </div>
            ...
            <p className="text-lg sm:text-xl text-slate-300 leading-relaxed max-w-xl">
              I'm an <span className="text-cyan-400 font-semibold">Undergraduate Student</span> pursuing a degree in <span className="text-blue-400 font-semibold">Bachelor of Science in Information Technology</span>.
            </p>
            
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-4">
              <a 
                href="mailto:kenjicaayohan55@gmail.com"
                className="group/email flex items-center gap-3 px-6 py-3 bg-slate-800/50 hover:bg-slate-800 border border-slate-700/50 hover:border-cyan-500/50 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/20"
              >
                <Mail size={18} className="text-cyan-400 group-hover/email:scale-110 transition-transform" />
                <span className="text-sm font-mono text-slate-300 group-hover/email:text-cyan-300">kenjicaayohan55@gmail.com</span>
              </a>
            </div>
            
            <div className="flex items-center gap-4 pt-2">
              <span className="text-sm text-slate-400 font-medium">Connect with me:</span>
              <div className="flex gap-3">
                <a 
                  href="https://www.facebook.com/kenken.caayohan" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="group/social p-3 bg-slate-800/50 hover:bg-cyan-500/10 border border-slate-700/50 hover:border-cyan-500/50 rounded-xl text-slate-400 hover:text-cyan-400 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-cyan-500/20"
                  aria-label="Facebook"
                >
          ...
          <div className="flex items-center justify-center order-1 lg:order-2">
            <div className="relative w-full max-w-md">
              ...
              <div className="relative bg-gradient-to-br from-slate-800/80 to-slate-900/80 rounded-2xl p-2 border border-slate-700/50 shadow-2xl overflow-hidden group/image">
                ...
                <div className="absolute top-4 right-4 w-2 h-2 bg-cyan-400 rounded-full opacity-60 group-hover/image:opacity-100 transition-opacity"></div>
                <div className="absolute bottom-4 left-4 w-2 h-2 bg-blue-400 rounded-full opacity-60 group-hover/image:opacity-100 transition-opacity"></div>
              </div>
            </div>
          </div>
        </div>
